      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#142332] border border-cyan-500/40 text-cyan-300 text-xs font-mono-tech font-medium mb-4 shadow-sm">
            <GraduationCap className="w-4 h-4 text-cyan-400 stroke-[1.75]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-[#142332] p-6 rounded-2xl border border-[#2b5b84] shadow-xl flex flex-col justify-between hover:border-cyan-400/60 transition-all duration-300">
            <div>
            ...
            <div className="mt-4 pt-4 border-t border-[#2b5b84] text-[11px] font-mono-tech text-cyan-300 font-medium flex items-center gap-1">
          ...
          <div className="bg-[#142332] p-6 rounded-2xl border border-[#2b5b84] shadow-xl flex flex-col justify-between hover:border-cyan-400/60 transition-all duration-300">
            <div>
              <div className="p-3 rounded-2xl bg-[#1b3852] text-sky-400 w-fit mb-4 border border-[#4b7da5]/40">
            ...
            <div className="mt-4 pt-4 border-t border-[#2b5b84] text-[11px] font-mono-tech text-emerald-400 font-medium flex items-center gap-1">
        ...
        <div className="bg-[#1b3852] p-6 sm:p-8 rounded-2xl border border-[#4b7da5]/50 shadow-2xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 mb-6 border-b border-[#2b5b84]">
            <div>
              <span className="text-xs font-mono-tech text-cyan-300 font-bold block mb-1">DEMOSTRACIÓN INTERACTIVA DE SIMULADOR</span>
              <h3 className="text-xl font-bold text-white">Laboratorio Virtual ECBTI-LAB-01</h3>
            </div>

            <div className="flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-[#142332] border border-emerald-500/40 text-emerald-400 text-xs font-mono-tech font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4 font-mono-tech text-xs">
              <div className="flex justify-between text-slate-200 font-bold">
                ...
                <span className="text-cyan-300 font-bold">{simulatorValue}%</span>
              </div>
              ...
              <input
                ...
                className="w-full h-2.5 bg-[#142332] rounded-lg appearance-none cursor-pointer accent-cyan-400"
              />
              ...
              <div className="p-4 bg-[#142332] rounded-2xl border border-[#2b5b84] flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-500/40 font-medium font-sans text-xs flex items-center gap-2 transition-colors disabled:opacity-50 shadow-sm cursor-pointer"
                >
            ...
            <div className="lg:col-span-6 bg-[#142332] p-5 rounded-2xl border border-[#2b5b84] space-y-3 font-mono-tech text-xs text-slate-200">
              <div className="flex justify-between items-center pb-2 border-b border-[#2b5b84] text-slate-400">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px] font-medium cursor-pointer"
                >
                  +500 Estudiantes
                </button>
              </div>
