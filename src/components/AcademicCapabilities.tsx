...
export const AcademicCapabilities: React.FC = () => {
  ...
  return (
    <section id="enfoque-academico" className="py-24 relative bg-slate-50 border-t border-slate-200 font-tech">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-mono-tech font-medium mb-4">
            <GraduationCap className="w-4 h-4 text-emerald-600 stroke-[1.75]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="p-3 rounded-2xl bg-slate-100 text-cyan-600 w-fit mb-4 border border-slate-200">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 text-[11px] font-mono-tech text-cyan-700 font-bold flex items-center gap-1">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="p-3 rounded-2xl bg-slate-100 text-emerald-600 w-fit mb-4 border border-slate-200">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 text-[11px] font-mono-tech text-emerald-700 font-bold flex items-center gap-1">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 mb-6 border-b border-slate-200">
            <div>
              <span className="text-xs font-mono-tech text-cyan-700 font-bold block mb-1">DEMOSTRACIÓN INTERACTIVA DE SIMULADOR</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4 font-mono-tech text-xs">
              <div className="flex justify-between text-slate-700 font-bold">
                ...
                <span className="text-cyan-700 font-bold">{simulatorValue}%</span>
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-bold font-sans text-xs flex items-center gap-2 transition-colors disabled:opacity-50 shadow-sm cursor-pointer"
                >
            ...
            <div className="lg:col-span-6 bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-3 font-mono-tech text-xs text-slate-200">
