...
export const CloudArchitecture: React.FC = () => {
  ...
  const getNodeIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'Cpu': return <Cpu className="w-5 h-5 text-[#2b5b84]" />;
  ...
  return (
    <section id="arquitectura-cloud" className="py-20 relative bg-slate-50 border-t-4 border-[#3775a9] font-tech text-slate-900">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 border border-slate-300 text-[#2b5b84] text-xs font-mono-tech font-bold mb-4 shadow-sm">
            <Cloud className="w-4 h-4 text-[#3775a9]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm relative">
            ...
            <div className="flex items-center justify-between pb-6 mb-6 border-b border-slate-200">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg bg-[#2b5b84] hover:bg-[#1b3852] text-white text-xs font-mono-tech font-bold flex items-center gap-2 transition-all disabled:opacity-50 cursor-pointer shadow-sm"
              >
                <Activity className={`w-3.5 h-3.5 text-white ${isSimulatingTraffic ? 'animate-spin' : ''}`} />
            ...
            <div className="space-y-4 relative py-4">
              ...
              {isSimulatingTraffic && (
                <div className="absolute left-6 top-8 bottom-8 w-1 bg-gradient-to-b from-emerald-500 via-[#3775a9] to-sky-500 animate-pulse z-20 pointer-events-none rounded-full" />
              )}
                ...
                return (
                  <div
                    ...
                    className={`p-4 sm:p-5 rounded-xl border cursor-pointer transition-all duration-300 flex items-center justify-between gap-4 ${
                      isSelected
                        ? 'bg-sky-50/60 border-[#3775a9] shadow-sm ring-1 ring-[#3775a9]/40 translate-x-1'
                        : 'bg-white border-slate-200 hover:border-[#3775a9]'
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className={`p-3 rounded-xl border ${
                          isSelected ? 'bg-white border-[#3775a9]' : 'bg-slate-50 border-slate-200'
                        }`}>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] font-mono-tech px-2 py-0.5 rounded bg-slate-100 text-[#2b5b84] border border-slate-300 font-bold">
                            {node.serviceType}
                          </span>
                        </div>
                    ...
                    <div className="hidden sm:flex flex-col items-end shrink-0">
                      <span className="text-xs font-mono-tech font-bold text-[#2b5b84]">{node.metrics}</span>
          ...
          <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm sticky top-28 text-slate-900">
            
            <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-6">
              <span className="text-xs font-mono-tech text-[#2b5b84] font-bold">INSPECTOR DE NODO AWS</span>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-[#2b5b84]">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 mb-6">
              ...
              <span className="text-lg font-mono-tech font-bold text-[#2b5b84]">{selectedNode.metrics}</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-xs font-bold text-[#2b5b84] hover:underline transition-colors"
              >
