...
Teléfonos: ${LEGAL_INFO.phone1Display} | ${LEGAL_INFO.phone2Display}`;
  ...
  return (
    <section id="cumplimiento" className="py-20 relative bg-slate-50 border-t-4 border-[#3775a9] font-tech text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 border border-slate-300 text-[#2b5b84] text-xs font-mono-tech font-bold mb-4 shadow-sm">
            <ShieldCheck className="w-4 h-4 text-[#3775a9] stroke-[1.75]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 bg-white p-6 sm:p-10 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between text-slate-900">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pb-6 mb-8 border-b border-slate-200">
                <div className="flex items-center gap-3">
                  <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 text-[#2b5b84]">
                    <Building2 className="w-6 h-6 stroke-[1.75]" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">{LEGAL_INFO.companyName}</h3>
                    <span className="text-xs font-mono-tech text-[#2b5b84] font-bold">NIT: {LEGAL_INFO.nit}</span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <div className="text-sm font-bold text-[#2b5b84] font-mono-tech">{LEGAL_INFO.niifCategory}</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {LEGAL_INFO.ciiuCodes.map((ciiu) => (
                    <div key={ciiu.code} className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex items-start gap-2.5">
                      <span className="px-2 py-0.5 rounded bg-white text-[#2b5b84] font-mono-tech font-bold text-xs border border-slate-300 shrink-0 shadow-sm">
                        {ciiu.code}
                      </span>
            ...
            <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-lg bg-[#2b5b84] hover:bg-[#1b3852] text-white font-mono-tech text-xs font-bold flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm"
              >
                {copied ? <Check className="w-4 h-4 text-emerald-300 stroke-[2]" /> : <Copy className="w-4 h-4 text-white stroke-[2]" />}
              ...
              <span className="text-[11px] font-mono-tech text-slate-600 text-center">
                Notificación Electrónica DIAN: <strong className="text-[#2b5b84]">{LEGAL_INFO.institutionalEmail}</strong>
              </span>
            </div>
          ...
          <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between text-slate-900">
            <div>
              <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 text-[#2b5b84] w-fit mb-6">
