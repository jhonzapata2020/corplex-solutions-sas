  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl my-auto pointer-events-auto font-tech">
        ...
        {/* Python.org Style Small Gold Button */}
        <button
          onClick={(e) => {
            e.stopPropagation();
            handleStart();
          }}
          className="px-5 py-2 rounded-md bg-[#ffd343] hover:bg-[#ffc520] text-[#111d28] font-bold text-sm shadow-md transition-all flex items-center gap-2 cursor-pointer active:scale-95"
        >
