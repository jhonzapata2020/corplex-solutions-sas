...
export const Hero: React.FC<HeroProps> = ({ onOpenQuoteModal }) => {
  ...
  return (
    <section id="inicio" className="bg-slate-50 text-slate-900 font-tech py-12 md:py-16 border-b border-slate-200">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Light Enterprise 2-Column Main Hero Card Container */}
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8 mb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-slate-900 rounded-xl p-5 border border-slate-800 shadow-sm font-mono-tech text-xs leading-relaxed text-slate-200 flex flex-col justify-between">
            ...
            {/* Right Column (5 cols): Featured Topic Box with Pagination Tabs 1 2 3 4 5 */}
              ...
              <div className="pt-8 flex items-center gap-2">
                {slideTopics.map((topic) => (
                  <button
                    ...
                    className={`w-9 h-9 rounded-lg text-xs font-bold font-mono-tech transition-all cursor-pointer ${
        ...
        {/* Light Enterprise Slogan Banner Bar */}
        <div className="text-center max-w-4xl mx-auto text-base sm:text-lg text-slate-700 font-medium leading-relaxed">
          <span>
          ...
          <a
            href="#cumplimiento"
            className="text-cyan-700 hover:underline font-bold inline-flex items-center gap-1"
          >
